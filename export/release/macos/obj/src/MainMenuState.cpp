...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_182_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",182,0x0e5db805)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_230_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",230,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_221_changeItem,"MainMenuState","changeItem",0xf62bd498,"MainMenuState.changeItem","MainMenuState.hx",221,0x0e5db805)
...
HXDLIN( 141)			if (_this->keyManager->checkStatus(55,_this->status)) {
HXLINE( 143)				::Main_obj::framerate = 800;
            			}
HXLINE( 146)			if (::PlayerSettings_obj::player1->controls->_downP->check()) {
HXLINE( 148)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 148)				_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
HXLINE( 149)				this->changeItem(1);
            			}
HXLINE( 152)			if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 154)				 ::flixel::FlxState nextState =  ::TitleState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 159)				if ((this->optionShit->__get(this->curSelected) == HX_("donate",6f,f1,29,2e))) {
HXLINE( 164)					::String prefix = HX_("",00,00,00,00);
HXDLIN( 164)					if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(HX_("https://ninja-muffin24.itch.io/funkin",69,b0,72,92)))) {
HXLINE( 164)						prefix = HX_("http://",52,75,cd,5a);
            					}
HXDLIN( 164)					::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + HX_("https://ninja-muffin24.itch.io/funkin",69,b0,72,92))),HX_("_blank",95,26,d9,b0));
            				}
            				else {
...
HXLINE( 176)						if ((_gthis->curSelected != spr->ID)) {
            							HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::flixel::FlxSprite,spr) HXARGC(1)
            							void _hx_run( ::flixel::tweens::FlxTween twn){
            								HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_182_update)
HXLINE( 182)								spr->kill();
            							}
            							HX_END_LOCAL_FUNC1((void))

HXLINE( 178)							::flixel::tweens::FlxTween_obj::tween(spr, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 190)								::String daChoice = _gthis->optionShit->__get(_gthis->curSelected);
HXLINE( 192)								::String _hx_switch_0 = daChoice;
            								if (  (_hx_switch_0==HX_("freeplay",a0,90,86,22)) ){
HXLINE( 198)									{
HXLINE( 198)										 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 198)										if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 198)											::flixel::FlxG_obj::game->_requestedState = nextState;
            										}
            									}
HXLINE( 200)									::haxe::Log_obj::trace(HX_("Freeplay Menu Selected",9c,6d,5a,ca),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),200,HX_("MainMenuState",59,88,5e,20),HX_("update",09,86,05,87)));
HXLINE( 197)									goto _hx_goto_4;
            								}
            								if (  (_hx_switch_0==HX_("options",5e,33,fe,df)) ){
HXLINE( 203)									 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 195)									{
HXLINE( 195)										 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 195)										if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 195)											::flixel::FlxG_obj::game->_requestedState = nextState;
            										}
            									}
HXLINE( 196)									::haxe::Log_obj::trace(HX_("Story Menu Selected",71,ff,9b,4a),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),196,HX_("MainMenuState",59,88,5e,20),HX_("update",09,86,05,87)));
...
HXLINE( 188)							::flixel::effects::FlxFlicker_obj::flicker(spr,1,((Float)0.06),false,false, ::Dynamic(new _hx_Closure_1(_gthis)),null());
            						}
            					}
            					HX_END_LOCAL_FUNC1((void))
...
HXDLIN( 170)					_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
HXLINE( 172)					::flixel::effects::FlxFlicker_obj::flicker(this->magenta,((Float)1.1),((Float)0.15),false,null(),null(),null());
HXLINE( 174)					this->menuItems->forEach( ::Dynamic(new _hx_Closure_2(_gthis)),null());
            				}
            			}
            		}
HXLINE( 212)		this->super::update(elapsed);
HXLINE( 214)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_3()),null());
            	}
...
void MainMenuState_obj::changeItem(::hx::Null< int >  __o_huh){
            		...
            		void _hx_run( ::flixel::FlxSprite spr){
            			HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_230_changeItem)
HXLINE( 231)			spr->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 233)			if ((spr->ID == _gthis->curSelected)) {
HXLINE( 235)				spr->animation->play(HX_("selected",5b,2a,6d,b1),null(),null(),null());
HXLINE( 236)				 ::flixel::FlxObject _gthis1 = _gthis->camFollow;
HXDLIN( 236)				Float _hx_tmp = spr->getGraphicMidpoint(null())->x;
HXDLIN( 236)				_gthis1->setPosition(_hx_tmp,spr->getGraphicMidpoint(null())->y);
            			}
HXLINE( 239)			spr->updateHitbox();
            		}
            		HX_END_LOCAL_FUNC1((void))

            		int huh = __o_huh.Default(0);
            	HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_221_changeItem)
HXDLIN( 221)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 222)		 ::MainMenuState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 222)		_hx_tmp->curSelected = (_hx_tmp->curSelected + huh);
HXLINE( 224)		if ((this->curSelected >= this->menuItems->length)) {
HXLINE( 225)			this->curSelected = 0;
            		}
HXLINE( 226)		if ((this->curSelected < 0)) {
HXLINE( 227)			this->curSelected = (this->menuItems->length - 1);
            		}
HXLINE( 229)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
...
HXDLIN(  39)		nightly = HX_(" (Week 7 Bulid)",c2,8b,2f,ca);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_41_boot)
HXDLIN(  41)		kadeEngineVer = (HX_("1.3.1",79,18,31,55) + ::MainMenuState_obj::nightly);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_42_boot)
HXDLIN(  42)		gameVer = HX_("0.2.8",be,c1,c9,c1);
            	}
}
