...
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_61_changePresence,"DiscordClient","changePresence",0xb0052162,"DiscordClient.changePresence","Discord.hx",61,0xa6c9e0b2)
...
HXLINE(  53)		 ::sys::thread::_Thread::HaxeThread DiscordDaemon = ::sys::thread::_Thread::HaxeThread_obj::create( ::Dynamic(new _hx_Closure_0()),false);
...
void DiscordClient_obj::changePresence(::String details,::String state,::String smallImageKey, ::Dynamic hasStartTimestamp, ::Dynamic endTimestamp){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_61_changePresence)
HXLINE(  62)		Float startTimestamp;
HXDLIN(  62)		if (( (bool)(hasStartTimestamp) )) {
HXLINE(  62)			startTimestamp = ::Date_obj::now()->getTime();
            		}
            		else {
HXLINE(  62)			startTimestamp = ( (Float)(0) );
            		}
HXLINE(  64)		if (::hx::IsGreater( endTimestamp,0 )) {
HXLINE(  66)			endTimestamp = (startTimestamp + endTimestamp);
            		}
HXLINE(  76)		 ::Dynamic _hx_tmp = ::Std_obj::_hx_int((startTimestamp / ( (Float)(1000) )));
HXLINE(  69)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(7)
