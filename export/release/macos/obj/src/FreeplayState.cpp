...
static const ::String _hx_array_data_b3f26131_7[] = {
	HX_("spooky",eb,bd,9e,c1),HX_("spooky",eb,bd,9e,c1),HX_("monster",1a,54,b0,b8),
};
...
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_156_addSong,"FreeplayState","addSong",0x9e966259,"FreeplayState.addSong","FreeplayState.hx",156,0x0d86f62d)
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_160_addWeek,"FreeplayState","addWeek",0xa1339e78,"FreeplayState.addWeek","FreeplayState.hx",160,0x0d86f62d)
static const ::String _hx_array_data_b3f26131_21[] = {
	HX_("bf",c4,55,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_175_update,"FreeplayState","update",0x9e1473a6,"FreeplayState.update","FreeplayState.hx",175,0x0d86f62d)
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_229_changeDiff,"FreeplayState","changeDiff",0x302511b2,"FreeplayState.changeDiff","FreeplayState.hx",229,0x0d86f62d)
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_253_changeSelection,"FreeplayState","changeSelection",0xbe8c8f7f,"FreeplayState.changeSelection","FreeplayState.hx",253,0x0d86f62d)
...
HXLINE(  44)				::Array< ::Dynamic> _hx_tmp = this->songs;
HXDLIN(  44)				_hx_tmp->push( ::SongMetadata_obj::__alloc( HX_CTX ,initSonglist->__get(i),1,HX_("gf",1f,5a,00,00)));
            			}
            		}
HXLINE(  57)		::DiscordClient_obj::changePresence(HX_("In the Menus",0a,c1,ad,c6),null(),null(),null(),null());
HXLINE(  60)		bool isDebug = false;
HXLINE(  66)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_4,3),1,::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_5,1));
HXLINE(  67)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_6,3),2,::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_7,3));
HXLINE(  68)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_8,3),3,::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_9,1));
HXLINE(  70)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_10,3),4,::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_11,1));
HXLINE(  71)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_12,3),5,::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_13,3));
HXLINE(  73)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_14,3),6,::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_15,3));
HXLINE(  75)		this->addWeek(::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_16,3),6,::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_17,3));
HXLINE(  81)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXDLIN(  81)		::String library1 = null();
HXDLIN(  81)		 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuBGBlue",de,35,e3,1e)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
HXLINE(  82)		this->add(bg1);
HXLINE(  84)		this->grpSongs =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE(  85)		this->add(this->grpSongs);
HXLINE(  87)		{
HXLINE(  87)			int _g2 = 0;
HXDLIN(  87)			int _g3 = this->songs->length;
HXDLIN(  87)			while((_g2 < _g3)){
HXLINE(  87)				_g2 = (_g2 + 1);
HXDLIN(  87)				int i = (_g2 - 1);
HXLINE(  89)				 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->songs->__get(i).StaticCast<  ::SongMetadata >()->songName,true,false);
HXLINE(  90)				songText->isMenuItem = true;
HXLINE(  91)				songText->targetY = ( (Float)(i) );
HXLINE(  92)				this->grpSongs->add(songText).StaticCast<  ::Alphabet >();
HXLINE(  94)				 ::HealthIcon icon =  ::HealthIcon_obj::__alloc( HX_CTX ,this->songs->__get(i).StaticCast<  ::SongMetadata >()->songCharacter,null());
HXLINE(  95)				icon->sprTracker = songText;
HXLINE(  98)				this->iconArray->push(icon);
HXLINE(  99)				this->add(icon);
            			}
            		}
...
HXLINE( 108)		this->scoreText->setFormat((HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82)),32,-1,HX_("right",dc,0b,64,e9),null(),null(),null());
...
void FreeplayState_obj::addSong(::String songName,int weekNum,::String songCharacter){
            	HX_GC_STACKFRAME(&_hx_pos_86166a84e8de7ace_156_addSong)
HXDLIN( 156)		::Array< ::Dynamic> _hx_tmp = this->songs;
HXDLIN( 156)		_hx_tmp->push( ::SongMetadata_obj::__alloc( HX_CTX ,songName,weekNum,songCharacter));
            	}
...
void FreeplayState_obj::addWeek(::Array< ::String > songs,int weekNum,::Array< ::String > songCharacters){
            	HX_STACKFRAME(&_hx_pos_86166a84e8de7ace_160_addWeek)
HXLINE( 161)		if (::hx::IsNull( songCharacters )) {
HXLINE( 162)			songCharacters = ::Array_obj< ::String >::fromData( _hx_array_data_b3f26131_21,1);
            		}
HXLINE( 164)		int num = 0;
HXLINE( 165)		{
HXLINE( 165)			int _g = 0;
HXDLIN( 165)			while((_g < songs->length)){
HXLINE( 165)				::String song = songs->__get(_g);
HXDLIN( 165)				_g = (_g + 1);
HXLINE( 167)				this->addSong(song,weekNum,songCharacters->__get(num));
HXLINE( 169)				if ((songCharacters->length != 1)) {
...
void FreeplayState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_86166a84e8de7ace_175_update)
...
HXLINE( 213)		if (accepted) {
HXLINE( 215)			::String poop = this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName.toLowerCase();
HXDLIN( 215)			::String poop1 = ::Highscore_obj::formatSong(poop,this->curDifficulty);
HXLINE( 217)			::haxe::Log_obj::trace(poop1,::hx::SourceInfo(HX_("source/FreeplayState.hx",21,2d,b0,ce),217,HX_("FreeplayState",31,61,f2,b3),HX_("update",09,86,05,87)));
HXLINE( 219)			::PlayState_obj::SONG = ::Song_obj::loadFromJson(poop1,this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName.toLowerCase());
HXLINE( 220)			::PlayState_obj::isStoryMode = false;
HXLINE( 221)			::PlayState_obj::storyDifficulty = this->curDifficulty;
HXLINE( 222)			::PlayState_obj::storyWeek = this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->week;
HXLINE( 223)			::haxe::Log_obj::trace((HX_("CUR WEEK",b4,9a,a0,36) + ::PlayState_obj::storyWeek),::hx::SourceInfo(HX_("source/FreeplayState.hx",21,2d,b0,ce),223,HX_("FreeplayState",31,61,f2,b3),HX_("update",09,86,05,87)));
HXLINE( 224)			{
HXLINE( 224)				 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
void FreeplayState_obj::changeDiff(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_86166a84e8de7ace_229_changeDiff)
HXLINE( 230)		 ::FreeplayState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 230)		_hx_tmp->curDifficulty = (_hx_tmp->curDifficulty + change);
HXLINE( 232)		if ((this->curDifficulty < 0)) {
HXLINE( 233)			this->curDifficulty = 2;
            		}
HXLINE( 234)		if ((this->curDifficulty > 2)) {
HXLINE( 235)			this->curDifficulty = 0;
            		}
HXLINE( 238)		this->intendedScore = ::Highscore_obj::getScore(this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName,this->curDifficulty);
HXLINE( 241)		switch((int)(this->curDifficulty)){
            			case (int)0: {
HXLINE( 244)				this->diffText->set_text(HX_("EASY",02,54,cd,2d));
            			}
            			break;
            			case (int)1: {
HXLINE( 246)				this->diffText->set_text(HX_("NORMAL",27,1e,ec,e2));
            			}
            			break;
            			case (int)2: {
HXLINE( 248)				this->diffText->set_text(HX_("HARD",eb,f6,c8,2f));
            			}
            			break;
            		}
            	}
...
void FreeplayState_obj::changeSelection(::hx::Null< int >  __o_change){
            		int change = __o_change.Default(0);
            	HX_STACKFRAME(&_hx_pos_86166a84e8de7ace_253_changeSelection)
HXLINE( 259)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 259)		_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 261)		 ::FreeplayState _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 261)		_hx_tmp1->curSelected = (_hx_tmp1->curSelected + change);
HXLINE( 263)		if ((this->curSelected < 0)) {
HXLINE( 264)			this->curSelected = (this->songs->length - 1);
            		}
HXLINE( 265)		if ((this->curSelected >= this->songs->length)) {
HXLINE( 266)			this->curSelected = 0;
            		}
HXLINE( 271)		this->intendedScore = ::Highscore_obj::getScore(this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName,this->curDifficulty);
HXLINE( 276)		::String _hx_tmp2 = ::Highscore_obj::formatSong(this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName,0);
HXDLIN( 276)		::Conductor_obj::changeBPM(( (int)(::Song_obj::loadFromJson(_hx_tmp2,this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName.toLowerCase())->__Field(HX_("bpm",df,be,4a,00),::hx::paccDynamic)) ));
HXLINE( 277)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::sound;
HXDLIN( 277)		_hx_tmp3->playMusic((((HX_("songs:assets/songs/",c1,ed,e6,7e) + this->songs->__get(this->curSelected).StaticCast<  ::SongMetadata >()->songName.toLowerCase()) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00)),0,null(),null());
HXLINE( 280)		int bullShit = 0;
HXLINE( 282)		{
HXLINE( 282)			int _g = 0;
HXDLIN( 282)			int _g1 = this->iconArray->length;
HXDLIN( 282)			while((_g < _g1)){
HXLINE( 282)				_g = (_g + 1);
HXDLIN( 282)				int i = (_g - 1);
HXLINE( 284)				this->iconArray->__get(i).StaticCast<  ::HealthIcon >()->set_alpha(((Float)0.6));
            			}
            		}
HXLINE( 287)		this->iconArray->__get(this->curSelected).StaticCast<  ::HealthIcon >()->set_alpha(( (Float)(1) ));
HXLINE( 289)		{
HXLINE( 289)			int _g2 = 0;
HXDLIN( 289)			::Array< ::Dynamic> _g3 = this->grpSongs->members;
HXDLIN( 289)			while((_g2 < _g3->length)){
HXLINE( 289)				 ::Alphabet item = _g3->__get(_g2).StaticCast<  ::Alphabet >();
HXDLIN( 289)				_g2 = (_g2 + 1);
HXLINE( 291)				item->targetY = ( (Float)((bullShit - this->curSelected)) );
HXLINE( 292)				bullShit = (bullShit + 1);
HXLINE( 294)				item->set_alpha(((Float)0.6));
HXLINE( 297)				if ((item->targetY == 0)) {
HXLINE( 299)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
            	}
