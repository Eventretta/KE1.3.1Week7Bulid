...
HXLINE( 635)			if (::Std_obj::isOfType( ::Dynamic(merge->__Field(HX_("merge",b8,a2,c6,05),::hx::paccDynamic)),::hx::ArrayBase::__mClass)) {
...
HXLINE( 748)			if (::Std_obj::isOfType(obj,::hx::ArrayBase::__mClass)) {
...
HXDLIN( 766)		if (::Std_obj::isOfType(a,::hx::ArrayBase::__mClass)) {
HXLINE( 766)			_hx_tmp = ::Std_obj::isOfType(b,::hx::ArrayBase::__mClass);
            		}
            		else {
...
HXDLIN( 771)			if (!(::Std_obj::isOfType(a,::hx::ArrayBase::__mClass))) {
HXLINE( 771)				_hx_tmp = !(::Std_obj::isOfType(b,::hx::ArrayBase::__mClass));
            			}
            			else {
...
HXDLIN( 809)				if (::Std_obj::isOfType(a,::hx::ArrayBase::__mClass)) {
...
HXDLIN( 810)				if (::Std_obj::isOfType(b,::hx::ArrayBase::__mClass)) {
...
HXLINE( 819)		if (::Std_obj::isOfType(a,::hx::ClassOf< int >())) {
HXLINE( 819)			b = ::Std_obj::_hx_int(( (Float)(a) ));
            		}
HXLINE( 820)		if (::Std_obj::isOfType(a,::hx::ClassOf< ::Float >())) {
HXLINE( 820)			b = ::hx::TCast< Float >::cast(a);
            		}
HXLINE( 821)		if (::Std_obj::isOfType(a,::hx::ClassOf< ::String >())) {
HXLINE( 821)			b = ::Std_obj::string(b);
            		}
HXLINE( 822)		if (::Std_obj::isOfType(a,::hx::ClassOf< bool >())) {
...
HXLINE( 829)		if (::Std_obj::isOfType(a,::hx::ClassOf< ::String >())) {
HXLINE( 829)			return true;
            		}
HXLINE( 830)		if (::Std_obj::isOfType(a,::hx::ClassOf< ::Float >())) {
HXLINE( 830)			return true;
            		}
HXLINE( 831)		if (::Std_obj::isOfType(a,::hx::ClassOf< int >())) {
HXLINE( 831)			return true;
            		}
HXLINE( 832)		if (::Std_obj::isOfType(a,::hx::ClassOf< bool >())) {
...
HXLINE( 863)			if (::Std_obj::isOfType(next,::hx::ArrayBase::__mClass)) {
...
HXLINE( 878)						if (::Std_obj::isOfType(next,::hx::ArrayBase::__mClass)) {
