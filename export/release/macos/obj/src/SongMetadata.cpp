...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_306_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",306,0x0d86f62d)
...
HXLINE( 310)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 309)		this->week = 0;
HXLINE( 308)		this->songName = HX_("",00,00,00,00);
HXLINE( 314)		this->songName = song;
HXLINE( 315)		this->week = week;
HXLINE( 316)		this->songCharacter = songCharacter;
            	}
