	...
	override public function create()
	{
		...
		switch(SONG.song.toLowerCase())
		{
			...
			case 'ugh' | 'guns' | 'stress':
			{
					defaultCamZoom = 0.9;
					curStage = 'stage';
					var bg:FlxSprite = new FlxSprite(-200, -100).loadGraphic(Paths.image('week7/tankSky'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);

					var stageFront:FlxSprite = new FlxSprite(-300, -20).loadGraphic(Paths.image('week7/tankMountains'));
					stageFront.updateHitbox();
					stageFront.antialiasing = true;
					stageFront.scrollFactor.set(0.9, 0.9);
					stageFront.active = false;
					...
					var stageCurtains:FlxSprite = new FlxSprite(-200, 300).loadGraphic(Paths.image('week7/tankBuildings'));
					stageCurtains.updateHitbox();
					stageCurtains.antialiasing = true;
					stageCurtains.scrollFactor.set(1.3, 1.3);
					stageCurtains.active = false;
					...
					var wa:FlxSprite = new FlxSprite(-300, 500).loadGraphic(Paths.image('week7/tankGround'));
					wa.updateHitbox();
					wa.antialiasing = true;
					wa.scrollFactor.set(1.3, 1.3);
					wa.active = false;
		...
		var kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + " - KE " + MainMenuState.kadeEngineVer + "", 16);
